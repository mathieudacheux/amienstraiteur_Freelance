                ...
                <div class="section-content bg-white p-5 shadow">
                    ...
                    <form method="post" action="/commande">
                        <div class="row">
                            ...
                            <div class="dishes d-flex flex-wrap justify-content-center col-12">
                                <script>
                                        fetch(`/getDishesAjax`)
                            ...
                            <div class="col-12 text-center d-flex justify-content-center form-group">
                                <div class="addDish col-2 form-control my-1">+</div>
                            </div>
