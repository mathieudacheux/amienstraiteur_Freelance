		...
		<div class="row">
			...
			<div class="col-lg-4">
				<div class="footer-widget px-lg-5 px-0">
					...
					<ul class="list-unstyled open-hours">
						<li class="d-flex justify-content-between"><span>Lundi</span><span>9:00 - 20:00</span></li>
						<li class="d-flex justify-content-between"><span>Mardi</span><span>9:00 - 20:00</span></li>
						<li class="d-flex justify-content-between"><span>Mercredi</span><span>9:00 - 20:00</span></li>
			...
			<div class="col-lg-4">
				<div class="footer-widget pl-lg-5 pl-0">
					<h4>Label</h4>
					<p>Notre cuisine est Halal en fonction de votre demande,
